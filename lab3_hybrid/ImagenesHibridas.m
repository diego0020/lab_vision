...
A = imread('einstein.bmp');
B = imread('marilyn.bmp');

kernel1 = fspecial('gaussian',[20 20],4);
kernel2 = fspecial('gaussian',[50 50],300);

Af = imfilter(A,kernel1);
Bf = B - imfilter(B,kernel2);

HI = Af + Bf;
HIC = vis_hybrid_image(HI);
