function phow_101Torres(Attemp,numIm,spatial,Claszs,ExperimentName)
...
savefig(fullfile(conf.dataDir,Attemp, strcat(ExperimentName,'.fig')))
print(fullfile(conf.dataDir,Attemp, strcat(ExperimentName)),'-dpng')
