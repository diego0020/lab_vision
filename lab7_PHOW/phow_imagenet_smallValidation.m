function ac = phow_imagenet_smallValidation(nTrain,nClass,nWords,nSpatial,C,pHowO)
...
conf.calDir = 'imagenet_small/train' ;
conf.dataDir = 'imagenet_small/' ;
conf.autoDownloadData = true ;
conf.numTrain = nTrain ;
conf.numTest = 20 ;
conf.numClasses = nClass ;
conf.numWords = nWords ;
conf.numSpatialX = nSpatial ;
conf.numSpatialY = nSpatial ;
...
ac = 100 * mean(diag(confus)/conf.numTest);
